...
genai.configure(api_key="AIzaSyAT8_moONkWrgdJ_G1jUBndNpes0t6dtJE")
...
def is_greeting(user_input):
    """
    Checks if the user input is a simple greeting using regular expressions.
    """
    # Define a regular expression pattern for common greetings
    greeting_pattern = r'\b(hello|hi|hey|greetings|good morning|aloo|good afternoon|good evening)\b'
    user_input_lower = user_input.lower()
...
def answer(user_input):
    ...
    user_input = user_input + ' (NB: answers based on KENYA Social Health Authority question)'
